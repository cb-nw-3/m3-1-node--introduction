...
const q3 = (req, res) => {
  ...
  res.render("pages/question3", { data: homer });
};
// -----------------------------------------------
...
const q4 = (req, res) => {
  ...
  const top3 = popularGirlNames.slice(0, 3);
  res.render("pages/question4", { topNames: top3 });
};
// -----------------------------------------------
...
const q5 = (req, res) => {
  ...
  res.render("pages/question5", { girlNames: popularGirlNames });
};
// -----------------------------------------------
