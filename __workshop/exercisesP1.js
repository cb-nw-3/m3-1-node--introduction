...
const q3 = (req, res) => {
  ...
  res.render("pages/question3", {
    homerImage: homer.imageUrl,
    homerName: homer.name,
    homerDob: homer.dob,
    homerProfession: homer.profession,
    homerFavFood: homer.favoriteFood,
    homerFavBeverage: homer.favoriteBeverage,
  });
};
// -----------------------------------------------
...
const q4 = (req, res) => {
  ...
  res.render("pages/question4", {
    topone: popularGirlNames[0],
    toptwo: popularGirlNames[1],
    topthree: popularGirlNames[2],
  });
};
// -----------------------------------------------
...
const q5 = (req, res) => {
  ...
  res.render("pages/question5", { popGirls: popularGirlNames });
};
// -----------------------------------------------
