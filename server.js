...
const q6 = (req, res) =>
  res.render("pages/question6", {
    htmlHead:
      '<!DOCTYPE html><head><title>Node: Workshop 1<link rel="stylesheet" href="./css/styles.css"></head>',
  }); //render = fournir la page / function
...
express() // backend server
  ...
  // endpoints
  .get("/question1", exercisesP1.q1) // go to exercises because res.render is on exercisesP1 page
